...
for (let i = 0; i < got.houses[0].people.length; i++) {
    if (got.houses[0].people[i].name == `Robb Stark`) {
        console.log(`${got.houses[0].people[i].name} and ${got.houses[0].people[i].description}`);
    }
}
...
for (let i = 0; i < got.houses[1].people.length; i++) {
    if (got.houses[1].people[i].name == `Tywin Lannister`) {
        console.log(`${got.houses[1].people[i].name} and ${got.houses[1].people[i].description}`);
    }
}
...
for (let houseName of got.houses) {
    houseInfo[houseName.name] = houseName.length;
}
