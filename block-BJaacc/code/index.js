...
Yes, we can define a key of let or var because whenever we define anything use these keywords then these keywords when used in place of key values, it become string data type.
`
``
